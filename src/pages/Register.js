...
function Register() {
    ...
    function register(e){
        ...
        fetch('https://gentle-wave-67856.herokuapp.com/api/users/checkEmail',
            ...
            .then(result => {
                console.log(result) //returns boolean. returns true if email has already been registered
                    if (result === true)
                        {
                            Swal.fire ({
                                title: 'Registration unsuccessful',
                                icon: 'error',
                                text: 'This email is already registered. Please login to your account or use another email'
                            })
                        }
                    else 
                        {
